...
// Assurez-vous que vos variables .env sont correctes
...
const app = express();
app.use(cors());
app.use(express.json({ limit: "20mb" })); // Augmenté pour les gros rapports
...
app.listen(3001, "0.0.0.0", () => {
    console.log("🔥 SERVEUR PRÊT SUR LE PORT 3001");
});